...
class Eth {
    ...
    */
    ...
    //            gasPrice
            ...
            console.error('getTopScoresCount error', e.message)
            return {
                err: e.message
            }
        }
    ...
    async getTopScores (index, count) {
        try {
            ...
            console.error('getTopScores error', e.message)
            return {
                err: e.message
            }
        }
    ...
    async setScore (score) {
        try {
            ...
            console.error('setScore error', e.message)
            return {
                err: e.message
            }
        }
...
//            resolve(await blockchain.getTopScoresCount()));
    ...
    async createPuzzleSecure (address, puzzleType, plainTextMetrics, metricsHash, checkOwner) {
        try {
            ...
            console.error('createPuzzleSecure error', e.message)
            return {
                err: e.message
            }
        }
    ...
    async pushSecureMetrics (puzzleId, metrics) {
        try {
            ...
            console.error('pushSecureMetrics error', e.message)
            return {
                err: e.message
            }
        }
    ...
    async compareSecureMetrics (puzzleId, byOwner) {
        try {
            ...
            console.error('compareMetrics error', e.message)
            return {
                err: e.message
            }
        }
    ...
    async createPuzzle (metrics) {
        try {
            ...
            console.error('createPuzzle error', e.message)
            return {
                err: e.message
            }
        }
    ...
    async pushMetrics (puzzleId, metrics) {
        try {
            ...
            console.error('pushMetrics error', e.message)
            return {
                err: e.message
            }
        }
    ...
    async getPuzzleOriginalMetrics (puzzleId) {
        try {
            ...
            console.error('getPuzzleOriginalMetrics error', e.message)
            return {
                err: e.message
            }
        }
    ...
    async getPuzzleMetrics (puzzleId) {
        try {
            ...
            console.error('getPuzzleMetrics error', e.message)
            return {
                err: e.message
            }
        }
